        ...
        mNoActivityAnimator.addListener(
                new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        if (CellState.mNoActivityPulseShouldRepeat && curPulses < numPulses) {
                            CellState.mNoActivityAnimator.start();
                            curPulses++;
                        } else {
                            CellState.mBucketListener.onNoActivityAnimationFinished();
                        }
                    }
                });
