...
public class UdfpsEnrollEnrollingView extends GlifLayout {
    ...
    private void setOnHoverListener() {
        if (mAccessibilityManager != null && mAccessibilityManager.isEnabled()) {
            ...
            viewGroup.setImportantForAccessibility(IMPORTANT_FOR_ACCESSIBILITY_NO_HIDE_DESCENDANTS);
            viewGroup.setAccessibilityLiveRegion(ACCESSIBILITY_LIVE_REGION_POLITE);
