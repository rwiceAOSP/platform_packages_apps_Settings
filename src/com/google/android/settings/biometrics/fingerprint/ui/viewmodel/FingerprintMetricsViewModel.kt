...
abstract class FingerprintMetricsViewModel : ViewModel() {
    var skipNextCancelAction: Boolean = false

    abstract fun appendAction(action: OnboardingAction)

    abstract fun setScreen(screen: OnboardingScreen)

    abstract fun sendMetricsToLogger(resultCode: Int): OnboardingEvent
}
